    ...
    <div class="creas">
      <div class="row">
        <div class="small-4 columns">
          <div class="thumb"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/portofolio1.jpg" alt=""></div>
        </div>
        <div class="small-4 columns">
          <div class="thumb"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/portofolio2.jpg" alt=""></div>
        </div>
        <div class="small-4 columns">
          <div class="thumb"></div>
        </div>
